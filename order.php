        ...
        <form action="" method="POST" class="order">
            <fieldset>
                ...
                <div class="food-menu-desc">
                    ...
                    <p class="food-price text-yellow">$<?php echo $price; ?></p>
            ...
            <fieldset>
                ...
                <input type="text" name="full-name" placeholder="E.g. Surya Kant Singh" class="input-responsive" required>

                <div class="order-label text-yellow">Phone Number</div>
                <input type="tel" name="contact" placeholder="E.g. 9843xxxxxx" class="input-responsive" required>

                <div class="order-label text-yellow">Email</div>
                <input type="email" name="email" placeholder="E.g. hi@surya.com" class="input-responsive" required>
